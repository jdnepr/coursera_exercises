...
public class Program {
    ...
    public static void main(String args[]) {
        ...
        //play experimental palylist, it should contain also pop play list
        experimentalPlaylist.setPlaybackSpeed(slowSpeed+0.7f);
        experimentalPlaylist.play();
